...
did *not* ship were regrouped by topic into [docs/research/](docs/research/) (see the pointers
...
- [data-package.md](data-package.md) — the companion `rati/data` package. **Shipped**
  ...
  consumer migrations, extraction) live in [docs/planned/data-package/](docs/planned/data-package/).
...
Two related decisions, archived one level up: [docs/archive/island-ssr-dehydration.md](docs/archive/island-ssr-dehydration.md)
(keep the framework-owned dehydration registry until a deliberate RSC adoption) and
[docs/archive/mandala-testing.md](docs/archive/mandala-testing.md) (the mandala testing strategy — altitude rule,
...
- `improvements.md` (dissolved) — its open options became
  ...
  [dx-and-tooling.md](docs/research/dx-and-tooling.md). Its two shipped items — "scope refresh
...
- The stores container restructuring (naming §6 + the router-decoupling shape change) did **not**
  ...
  [stores-container-implementation.md](docs/research/stores-container-implementation.md) (the
  Option A plan).
