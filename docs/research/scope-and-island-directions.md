...
(undecided/deferred-scope-features.md), the cross-layer
`derive()` escape hatch (undecided/dependency-graphs.md), and
the router-side resolution work (router-extensions.md).
...
(router-extensions.md, the layout-level scope idea) a sanctioned
