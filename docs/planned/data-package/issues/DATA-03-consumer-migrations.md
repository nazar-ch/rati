...
For each leg: line-count and concept-count before/after, and a dated findings note in the README — especially anywhere the primitives forced a workaround (that is the signal DATA-04 needs).
...
- Jnana's own gates green after each leg; the before/after deltas recorded in the README with the findings.
